...
import { Sparkles, Heart, NotebookIcon as Lotus } from "lucide-react"
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-20 left-10 animate-bounce">
        <Lotus className="h-8 w-8 text-white/30" />
      </div>
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
        <div className="mb-6">
          <span className="inline-block px-4 py-2 bg-white/20 rounded-full text-sm font-medium backdrop-blur-sm">
            🕉️ R-zone - Authentic Indian Wellness Experience
          </span>
        </div>

        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
          Transform Your Life at
          <span className="block text-yellow-300">R-zone Fitness</span>
        </h1>

        <p className="text-lg md:text-xl mb-8 text-white/90 max-w-2xl mx-auto leading-relaxed">
          Experience the perfect blend of traditional yoga, personalized AI wellness plans, and holistic healing. Begin
