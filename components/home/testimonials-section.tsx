...
export default function TestimonialsSection() {
  const testimonials = [
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=80&width=80",
      rating: 5,
      text: "Serenity Yoga Studio is a sanctuary in the city. The combination of traditional yoga practices with modern technology is brilliant. The astrology consultation helped me understand myself better.",
    },
    {
      name: "Meera Patel",
      role: "Teacher",
    ...
    <section className="py-20 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 yoga-text-gradient">What Our Students Say</h2>
